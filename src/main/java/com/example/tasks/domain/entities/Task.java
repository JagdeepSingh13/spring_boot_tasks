...
public class Task {
    ...
    public Task(TaskStatus status, UUID id, String title, String description, LocalDateTime dueDate, TaskPriority priority, LocalDateTime created, LocalDateTime updated) {
        this.status = status;
        this.id = id;
        this.title = title;
